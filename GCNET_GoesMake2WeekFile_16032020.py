...
def WriteCFile(fid,DatasetN):
    ...
    else: #if there is nothing in DatasetN we still write the empty file
        np.savetxt(fid,DatasetN)

GStation_numbers = np.array([0,1,2,3,6,8,9,10,11,12,15,23,24,30]);
stations = GStation_numbers;
